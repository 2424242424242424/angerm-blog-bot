        ...
        for item in items:
            ...
            if group_key in ["angerme", "angerme-ss-shin"]:
                ...
                prompt_text = (
                    ...
                    f"9. 【行間を読んで！愛ある深掘り要約】メンバーがブログに込めた「本当に伝えたかった感情や中心的な意図」を行間から優しく汲み取って、絶対に意図がズレないように要約してね。若者ならではの言葉選びや、ちょっと独特でユニークな感性は、彼女たちの最高の魅力です。常識的な言葉に丸めたりせず、その瑞々しい感性を全力で肯定して、とびきり愛おしく捉える視座で表現してください！\n"
                    f"10. 【「楽しかった」で済ませないで！】「楽しかった」「美味しかった」みたいな、平易すぎて誰にでも書ける単調なまとめはNG。彼女たちの一瞬一瞬の煌めきやニュアンスが、オタクの胸にしっかり届く言葉を選んでね。\n"
                    f"11. 【熱量の比重を反映！】ブログの中で本人がいちばん盛り上がっている話題（文章量や文字から溢れるパッションが多い部分）が、要約の中でも主軸（最大構成要素）になるよう、しっかり比重を合わせて構成してね。"
                )
